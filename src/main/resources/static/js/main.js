...
function addCustomUser(name, curId) {
    $("#users").append('<div class="custom-user"' + 'cur-id="' + curId +'">' + name + '<button type="button" class="btn btn-default btn-xs delete-custom-user"> <span class="glyphicon glyphicon-star glyphicon-remove" aria-hidden="true"></span>Delete</button><br>   </div>');
}
